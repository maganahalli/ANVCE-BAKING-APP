...
public interface BakingAppConstants {
    ...
    String STEPS_FRAGMENT_TAG = "STEPS_FRAGMENT_TAG";
    String STEP_DETAIL_FRAGMENT_TAG = "STEP_DETAIL_FRAGMENT_TAG";
    String STEP_EXTRA = "STEP_EXTRA";
    String STEP_ID = "STEP_ID";
    String WAKE_LOG_TAG = "BACKINGAPP:WAKE_LOG_TAG";
    String PREFS_STEPS_ADAPTER_POSITION = "STEPS_ADAPTER_POSITION";
    String RECIPE ="RECIPE_DETAILS";
